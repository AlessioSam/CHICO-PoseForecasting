...
#{'Pelvis' 'RHip' 'RKnee' 'RAnkle' 'LHip' 'LKnee'
...
def visualize(input_n,output_n,visualize_from,path,modello,device,n_viz):
    
    if visualize_from=='train':
        loader=Datasets(path,input_n,output_n,split=0)
    elif visualize_from=='validation':
        loader=Datasets(path,input_n,output_n,split=1)
    elif visualize_from=='test':
        loader=Datasets(path,input_n,output_n,split=2)
